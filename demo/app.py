...
Chạy (từ thư mục gốc repo): streamlit run demo/app.py
"""
...
def _resolve_subject_store(subject_cfg: dict) -> tuple[str, str]:
    chroma_dir = _REPO_ROOT / subject_cfg["chroma_dir_vn_bi_ft"]
    return str(chroma_dir), subject_cfg["collection_vn_bi_ft"]
